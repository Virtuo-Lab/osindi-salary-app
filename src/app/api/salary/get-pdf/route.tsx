...
export async function POST(req: NextRequest) {
  ...
  const page = pdfDoc.addPage([400, 700]); // Decreased width for better layout
  ...
  const otHoursText = `${salaryDetails[0].otHours} h`;
  ...
  const otTitleX = 50;
  const otHoursX = 50 + 100 + 60; // Adjusted X position for otHours
  ...
  const workingHolidayCountX = 50 + 100 + 60; // Adjusted X position for workingHolidayCount
